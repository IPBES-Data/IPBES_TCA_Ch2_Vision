...
The differences the [original search term](./input/tca_corpus/search%20terms/strategies_options.org.txt) and the [used search term](./input/tca_corpus/search%20terms/strategies_options.txt) is shown below
