...
data <- read_corpus(file.path("data", "corpus")) |>
...
TODO These maps still use the results from the OpenAlex query, not the arrow database. But the differences should be minimal and this will be changed.
