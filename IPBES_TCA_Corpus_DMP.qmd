...
params:
    ...
    st_creativity: !expr paste0(readLines(file.path("input", "tca_corpus", "search terms", "creativity.txt")),   collapse = "\n")
    ...
    pages_strategies_dir: !expr file.path(".", "data", "tca_corpus", "pages_strategies")
    pages_actors_dir: !expr file.path(".", "data", "tca_corpus", "pages_actors")
...
fn <- file.path(".", "data", "tca_corpus", "tca_corpus_languages.rds")
...
These are the languages of the abstract and title. Articles with multiple languages will be counted not accurate. Also, as this is
the language of the abstract / title, it might not be the language of the full text.

```{r}
readRDS(file.path(".", "data", "tca_corpus", "tca_corpus_languages.rds"))$languages |>
    IPBES.R::table_dt(
...
The file [strategies_options.md](input/tca_corpus/search terms/strategies_options.md) contains the terms for the different strategies and options.
...
fn <- file.path("data", "tca_corpus", "strategies_options_ids.rds")

if (!file.exists(fn)) {
    strategies__options_terms <- readRDS(file.path("data", "tca_corpus", "strategies_options_terms.rds"))
...
fn <- file.path("data", "tca_corpus", "strategies_options_corpus.rds")

if (!file.exists(fn)) {
    strategies_options_terms <- readRDS(file.path("data", "tca_corpus", "strategies_options_terms.rds"))
    strategies_options_ids <- readRDS(file.path("data", "tca_corpus", "strategies_options_ids.rds"))
...
fn <- file.path("data", "tca_corpus", "strategies_options_overlap.rds")
...
#### Strategies / Options in Case Corpus

```{r}
#| label: cases_strategies_options_corpus
#|

fn <- file.path("data", "tca_corpus", "strategies_options_case.rds")
...
if (!file.exists(fn)) {
    ...
    strategies_options_case <- lapply(
        names(strategies_options_ids),
        function(strategy) {
            message("- ", strategy)
            count <- sum(strategies_options_ids[[strategy]] %in% case_ids)
            data.frame(
                strategy_option = strategy,
                count_cases = count,
                count_tca = length(strategies_options_ids[[strategy]]),
                p_cases = count / length(strategies_options_ids[[strategy]])
            )
        }
    ) |>
        do.call(what = rbind)

    strategies_options_case <- list(
        timestamp = Sys.time(),
        strategies_options_case = strategies_options_case
    )

    saveRDS(strategies_options_case, file = fn)
}
```
...
# strategies_options_corpus <- readRDS(file.path("data", "tca_corpus", "strategies_options.rds"))

# data from corpora
strategies_options <- readRDS(file.path("data", "tca_corpus", "strategies_options_corpus.rds"))
...
figname <- file.path("figures", "tca_corpus", "strategies_options_time_split")
...
The differences the [original search term](./input/tca_corpus/search%20terms/strategies_options.org.md) and the [used search term](./input/tca_corpus/search%20terms/strategies_options.md) is shown below
...
readRDS(file.path("data", "tca_corpus", "strategies_options_case.rds"))$strategies_options_case |>
    dplyr::mutate(
...
fn <- file.path("figures", "tca_corpus", "strategies_options_interactive_matrix")

if (!file.exists(paste0(fn, ".html"))) {
    data <- readRDS(file.path("data", "tca_corpus", "strategies_options_overlap.rds"))
    ...
    g <- igraph::graph_from_adjacency_matrix(data, mode = "undirected", weighted = TRUE, diag = FALSE)
    ...
    grid_size <- ceiling(sqrt(nrow(nodes)))
    nodes$x <- rep(1:grid_size, each = grid_size)[1:nrow(nodes)] * 300 # scale x coordinates
    nodes$y <- rep(1:grid_size, times = grid_size)[1:nrow(nodes)] * 300 # scale y coordinates

    # Center the nodes
    nodes$x <- nodes$x - max(nodes$x) / 2
    nodes$y <- nodes$y - max(nodes$y) / 2

    nodes$strategy <- sapply(strsplit(nodes$label, " \\|\\|\\| "), `[`, 1)
    nodes$option <- sapply(strsplit(nodes$label, " \\|\\|\\| "), `[`, 2)
    ...
    webshot::webshot(paste0(fn, ".html"), file = paste0(fn, ".pdf"))

    unlink(paste0(fn, "_files"), recursive = TRUE)
}
```

<iframe src="figures/tca_corpus/strategies_options_interactive_matrix.html" width="100%" height="800px"></iframe>

```{r}
#| label: strategies_option_overlap_table
#|

readRDS(file.path("data", "tca_corpus", "strategies_options_overlap.rds")) |>
    IPBES.R::table_dt(
...
The file [actors.md](input/tca_corpus/search terms/actors.md) contains the terms for the different actors.
...
fn <- file.path("data", "tca_corpus", "actors_ids.rds")
...
fn <- file.path("data", "tca_corpus", "actors_corpus.rds")

if (!file.exists(fn)) {
    actors_terms <- readRDS(file.path("data", "tca_corpus", "actors_terms.rds"))
    actors_ids <- readRDS(file.path("data", "tca_corpus", "actors_ids.rds"))
...
fn <- file.path("data", "tca_corpus", "actors_overlap.rds")
...
fn <- file.path("data", "tca_corpus", "actors_case.rds")
...
# data from corpora
actors <- readRDS(file.path("data", "tca_corpus", "actors_corpus.rds"))
...
The differences the [original search term](./input/tca_corpus/search%20terms/actors.org.md) and the [used search term](./input/tca_corpus/search%20terms/actors.md) is shown below
...
figname <- file.path("figures", "tca_corpus", "actors_time_split")
...
![The graph shows the by overall research output corrected publications before and after 1992 for each `Actor`](`r file.path("figures", "tca_corpus", "actors_time_split.png")`)

To download high resolution, [click here](`r file.path("figures", "tca_corpus", "actors_time_split.pdf")`){target="_blank"}

![The second graph shows the proportion of the by overall research output corrected publications before and after 1992 for each `Actor`](`r file.path("figures", "tca_corpus", "actors_time_split_p.png")`)

To download high resolution, [click here](`r file.path("figures", "tca_corpus", "actors_time_split+p.pdf")`){target="_blank"}
...
readRDS(file.path("data", "tca_corpus", "actors_case.rds"))$actors_case |>
    dplyr::mutate(
        p_cases = round(p_cases, 4)
    ) |>
    IPBES.R::table_dt(
...
fn <- file.path("figures", "tca_corpus", "actors_interactive_matrix")

if (!file.exists(paste0(fn, ".html"))) {
    data <- readRDS(file.path("data", "tca_corpus", "actors_overlap.rds"))
...
<iframe src="figures/tca_corpus/actors_interactive_matrix.html" width="100%" height="800px"></iframe>

```{r}
#| label: actors_overlap_table
#|

readRDS(file.path("data", "tca_corpus", "actors_overlap.rds")) |>
    IPBES.R::table_dt(
        fn = "actors_overlap",
        fixedColumns = list(leftColumns = 1)
    )
...
fn <- file.path("data", "tca_corpus", "actors_strategies_options_overlap.rds")

if (!file.exists(fn)) {
    actors_ids <- file.path("data", "tca_corpus", "actors_ids.rds") |> readRDS()
    strategies_options_ids <- file.path("data", "tca_corpus", "strategies_options_ids.rds") |> readRDS()
...
readRDS(file.path("data", "tca_corpus", "actors_strategies_options_overlap.rds")) |>
    IPBES.R::table_dt(
...
fn <- file.path("figures", "tca_corpus", "actors_strategies_options_matrix")
...
if (n < 2) {
    data <- readRDS(file.path("data", "tca_corpus", "actors_strategies_options_overlap.rds"))
    actors_count <- sapply(
        readRDS(file.path("data", "tca_corpus", "actors_ids.rds")),
        length
    )
    strategies_options_count <- sapply(
        readRDS(file.path("data", "tca_corpus", "strategies_options_ids.rds")),
        length
    )

    for (i in 1:nrow(data)) {
        data[i, ] <- data[i, ] / strategies_options_count[i]
    }


    for (i in 1:ncol(data)) {
        data[, i] <- data[, i] / actors_count[i]
    }

    colnames(data)  <- strsplit(colnames(data), split = "\\ \\|\\|\\|\\ ") |> sapply(FUN = "[[", 2)
    rownames(data)  <- strsplit(rownames(data), split = "\\ \\|\\|\\|\\ ") |> sapply(FUN = "[[", 2)
    
    p <- as.data.frame(as.table(data)) |>
...
![](`r file.path("figures", "tca_corpus", "actors_strategies_options_matrix.png")`)

To download high resolution, [click here](figures/tca_corpus/actors_strategies_options_matrix.pdf`){target="_blank"}
...
fn <- file.path("figures", "tca_corpus", "strategies_options_dendrogram_interactive.html")
if (!file.exists(fn)) {
    ...
    unlink(file.path("figures", "tca_corpus", "strategies_options_dendrogram_interactive_files"), recursive = TRUE)
}
```

<iframe src="figures/tca_corpus/strategies_options_dendrogram_interactive.html" width="100%" height="800px"></iframe>

To open the interactive graph or to download it, [click here](figures/tca_corpus/strategies_options_dendrogram_interactive.html){target="_blank"}
...
if (length(list.files(file.path("figures", "tca_corpus"), pattern = "strategies_options_dendrogram_circular")) < 2) {
    ...
    ggplot2::ggsave(
        plot = p,
        file.path("figures", "tca_corpus", "strategies_options_dendrogram_circular.pdf"),
        width = 12,
        height = 6
    )
    ggplot2::ggsave(
        plot = p,
        file.path("figures", "tca_corpus", "strategies_options_dendrogram_circular.png"),
        width = 12,
        height = 6
    )
}
...
![](`r file.path("figures", "tca_corpus", "strategies_options_dendrogram_circular.png")`)

To download high resolution, [click here](figures/tca_corpus/strategies_options_dendrogram_circular.pdf`){target="_blank"}
...
fn <- file.path("figures", "tca_corpus", "actors_dendrogram_interactive.html")
if (!file.exists(fn)) {
    p <- collapsibleTree::collapsibleTree(
        sts,
    ...
    unlink(file.path("figures", "tca_corpus", "actors_dendrogram_interactive_files"), recursive = TRUE)
}
```

<iframe src="figures/tca_corpus/actors_dendrogram_interactive.html" width="100%" height="800px"></iframe>

To open the interactive graph or to download it, [click here](figures/tca_corpus/actors_dendrogram_interactive.html){target="_blank"}
...
if (length(list.files(file.path("figures", "tca_corpus"), pattern = "actors_dendrogram_circular")) < 2) {
    ...
    ggplot2::ggsave(
        plot = p,
        file.path("figures", "tca_corpus", "actors_dendrogram_circular.pdf"),
        width = 12,
        height = 6
    )
    ggplot2::ggsave(
        plot = p,
        file.path("figures", "tca_corpus", "actors_dendrogram_circular.png"),
        width = 12,
        height = 6
    )
}
...
![](`r file.path("figures", "tca_corpus", "actors_dendrogram_circular.png")`)

To download high resolution, [click here](figures/tca_corpus/actors_dendrogram_circular.pdf`){target="_blank"}
