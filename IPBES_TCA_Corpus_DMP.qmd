...
params:
    ...
    key_papers:
#      - Ch_1:
        - "./inputs/tca_corpus/key papers/Ch 1 - Arun.csv"
        - "./inputs/tca_corpus/key papers/Ch 1 - pdf.csv"
        - "./inputs/tca_corpus/key papers/Ch 1 - word.csv"
#      - Ch_2:
        - "./inputs/tca_corpus/key papers/Ch 2 - pdf.csv"
        - "./inputs/tca_corpus/key papers/Ch 2 - Sebastian.csv"
#      - Ch_3_Cl_1:
        - "./inputs/tca_corpus/key papers/Ch 3 - Cl1.csv"
#      - Ch_3_Cl_3:
        - "./inputs/tca_corpus/key papers/Ch 3 - Cl3.csv"
#      - Ch_3_Cl_4:
        - "./inputs/tca_corpus/key papers/Ch 3 - Cl4.csv"
#      - Ch_3_Cl_5:
        - "./inputs/tca_corpus/key papers/Ch 3 - Cl5.csv"
#      - Ch_3Cl_6:
        - "./inputs/tca_corpus/key papers/Ch 3 - Cl6.csv"
#      - Ch_3:
        - "./inputs/tca_corpus/key papers/Ch 3 - pdf.csv"
#      - Ch_4_Cl_1:
        - "./inputs/tca_corpus/key papers/Ch 4 - Challenge 1.csv"
#      - Ch_4_Cl_2:
        - "./inputs/tca_corpus/key papers/Ch 4 - Challenge 2.csv"
#      - Ch_4_Cl_3:
        - "./inputs/tca_corpus/key papers/Ch 4 - Challenge 3.csv"
#      - Ch_4_Cl_4:
        - "./inputs/tca_corpus/key papers/Ch 4 - Challenge 4.csv"
#      - Ch_4_Cl_5:
        - "./inputs/tca_corpus/key papers/Ch 4 - Challenge 5.csv"
#      - Ch_5:
        - "./inputs/tca_corpus/key papers/Ch 5 - Hannah.csv"
        - "./inputs/tca_corpus/key papers/Ch 5 - Victoria.csv"
        - "./inputs/tca_corpus/key papers/Ch 5 -.csv"
...
gdm_dir <- file.path(".", "data", "gdm_dir")
...
fn <- file.path(".", "data", "tca_corpus", "abstracts_tca.parquet")
if (!file.exists(fn)) {
    IPBES.R::corpus_read(corpus_dir) |>
        select(
            id,
            doi,
            display_name,
...
if (!file.exists(fn)) {
    ...
    auth <- auth[sapply(auth, class) != "try-error"] |>
        dplyr::bind_rows() |>
        dplyr::arrange(publication_year, iso3c)
...
```{r}
#| label: countries_tca_corpus_before_2016_map
#|
...
```{r}
#| label: countries_tca_corpus_after_2019_map
#|
...
The Sectors definition is based on the subfields assigned to each work by OpenAlex. These were grouped by experts into sectors. See [this Google Doc](https://docs.google.com/spreadsheets/d/1ZCB_St2TQu_wL3yl1iN7Wxz5FERGxk-GZA0_2oGcRM0/edit#gid=210658071) for details.

```{r}
#| label: sectors_tca_corpus_data
#|

sector_dir <- file.path(".", "data", "tca_corpus", "sectors")

if (!dir.exists(sector_dir)) {
    dir.create(sector_dir, showWarnings = FALSE)
...
if (!file.exists(fn)) {
    data <- IPBES.R::corpus_read(file.path(".", "data", "tca_corpus", "sectors")) |>
        dplyr::group_by(
            publication_year,
            sector,
            i
...
![](`r file.path("maps", "tca_corpus", "publications_countries_before_2016.png")`)

To download high resolution, [click here](`r file.path("maps", "tca_corpus", "publications_countries_before_2016.pdf")`){target="_blank"}

#### All Years


![](`r file.path("maps", "tca_corpus", "publications_countries_after_2019.png")`)

To download high resolution, [click here](`r file.path("maps", "tca_corpus", "publications_countries_after_2019.pdf")`){target="_blank"}
