...
fn <- file.path("tca_corpus", "data", "strategies_options_case.rds")
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "strategies_options_time_split+p.pdf")`){target="_blank"}
...
readRDS(file.path("tca_corpus", "data", "strategies_options_case.rds"))$strategies_options_case |>
    dplyr::mutate(
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "actors_time_split+p.pdf")`){target="_blank"}
