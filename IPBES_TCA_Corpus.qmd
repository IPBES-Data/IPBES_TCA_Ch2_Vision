...
The data files of the repository are deposited in a separate Zenodo deposit untder the doi [10.5281/zenodo.11370840](https://doi.org/10.5281/zenodo.11370840). To re-download these, simply delete the `data` directory and run this code (or compile the report).
