---
title: 'Thematic assessment of the underlying causes of biodiversity loss, determinants of transformative change and options for achieving the 2050 vision for biodiversity - Transformative Change Assessment Corpus - Technical Background Report'
author:
  - name: 
        family: Krug
        given: Rainer M.    
...
if (!exists("params")) {
    params <- rmarkdown::yaml_front_matter("./IPBES_TCA_Corpus.qmd")$params
}
...
The following searches are conducted on Title and Abstrat only as the availability of fulltext drops in 2020. OpenAlex did "inherit" from Microsoft Academic their initial corpus in 2021 which contained a many fulltext articles. After that time, other sources wer used to  which did not include fulltext for searches. To eliminate this bias, we limit the search for terms to search in abstract and title only.
...
basename <- file.path("tca_corpus", "figures", "tca_corpus_overview")
...
The data files of the repository are deposited in a separate Zenodo deposit untder the doi [10.5281/zenodo.11370839](https://doi.org/10.5281/zenodo.11370839). To re-download these, simply delete the `data` directory and run this code (or compile the report).

This code will only work after the approval of the assessment as the repository will remain confidential before.
...
for (fn in fns) {
    if (!file.exists(fn)) {
        url <- paste0("https://zenodo.org/record/11370840/files/", fn) |>
...
```{r}
#| label: s_1_transformative_change_selected
...
```{r}
#| label: s_1_nature_environment_selected
#|
...
In contrast to the other search term, this one contains multiple sets of search terms

```{r}
#| label: sts_strategies_options_selected
#|

cat(params$sts_strategies_options |> paste0(collapse = "\n"))
```
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "publications_over_time.pdf")`){target="_blank"}
...
To download high resolution, [click here](`r file.path("tca_corpus", "maps", "sectors_proportions_over_time.pdf")`){target="_blank"}
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "strategies_options_time_split.pdf")`){target="_blank"}
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "strategies_options_time_split_p.pdf")`){target="_blank"}
...
To download high resolution pdf, [click here](`r file.path("tca_corpus", "figures", "strategies_options_interactive_matrix.pdf")`){target="_blank"}
...
To download high resolution pdf, [click here](`r file.path("tca_corpus", "figures", "strategies_options_interactive_matrix_cases.pdf")`){target="_blank"}
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "actors_time_split.pdf")`){target="_blank"}
...
To download high resolution, [click here](`r file.path("tca_corpus", "figures", "actors_time_split_p.pdf")`){target="_blank"}
...
To download high resolution pdf, [click here](`r file.path("tca_corpus", "figures", "actors_interactive_matrix.pdf")`){target="_blank"}
...
To download high resolution pdf, [click here](`r file.path("tca_corpus", "figures", "actors_interactive_matrix_cases.pdf")`){target="_blank"}
...
To download high resolution, [click here](tca_corpus/figures/actors_strategies_options_matrix.pdf){target="_blank"}
...
To download high resolution, [click here](tca_corpus/figures/actors_strategies_options_matrix_cases.pdf){target="_blank"}
...
To download high resolution, [click here](tca_corpus/figures/actors_strategies_options_matrix_difference.pdf){target="_blank"}
...
To download high resolution pdf, [click here](tca_corpus/figures/actors_strategies_options_combined_panel.pdf){target="_blank"}

To download high resolution svg, [click here](tca_corpus/figures/actors_strategies_options_combined_panel.pdf){target="_blank"}
...
To download high resolution, [click here](tca_corpus/figures/strategies_options_dendrogram_circular.pdf`){target="_blank"}
...
To download high resolution, [click here](tca_corpus/figures/actors_dendrogram_circular.pdf`){target="_blank"}



# Parking Lot - Additional Analysis
...
To download high resolution, [click here](`r file.path("tca_corpus", "maps", "publications_countries.pdf")`){target="_blank"}
...
To download high resolution, [click here](`r file.path("tca_corpus", "maps", "sectors_over_time.pdf")`){target="_blank"}
