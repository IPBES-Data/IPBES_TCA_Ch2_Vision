---
title: 'Chapter 5 Subsidies Reform - Technical Background Report'
...
if (!exists("params")) {
    params <- rmarkdown::yaml_front_matter("IPBES_TCA_Ch5_subsidies_reform.qmd")$params
}
...
[Github - private](https://github.com/IPBES-Data/IPBES_TCA_Corpus/tree/DMR_final)

## Build No: `r build`

The Build No is automatically increased by one each time the report is rendered. It is used to indicate different renderings when the version stays the same.
...
The `data` folder is also available in a separate deposit at [10.5281/zenodo.11389148](https://doi.org/10.5281/zenodo.11389258).
...
All code to re-generate the data is included, but it might take a long time to run and produce different numbers as OpenAlex is updated continuously.
...
This code will only work after the approval of the assessment by the Plenary as the repository will remain restricted before.
...
The search terms is [st](ch_5_subsidies_refrm/input/government_financial_support.txt){target=_blank}
...
Check the number of duplicates before running this next block, and then verify the new corpus afterwards. RUN MANUALLY ONLY!
...
### Export 250 papers for manual analysis randomly
...
## Spatial overview of the countries of the authors
...
The number of hits are hits of the terms of the whole of the OpenAlex corpus. Due to methodological issues, the number of `R1 AND R2` are overestimates and contain some duplicates.
...
## Manual review of 50 references
...
The red line is the cumulative proportion of publications, the blue line the cumulative proportion of all of the OpenAlex corpus. Both use the secondary (red) axis.
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "publications_over_time.pdf")`){target="_blank"}
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "sentiments_over_time.pdf")`){target="_blank"}


For clarity, here only the positive and negative sentiments.

![](`r file.path("ch5_subsidies_reform", "figures", "sentiments_over_time_neg_pos.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "sentiments_over_time_neg_pos.pdf")`){target="_blank"}
...
This graphs shows the **negative score** of the sentiment analysis over time. 


![](`r file.path("ch5_subsidies_reform", "figures", "sentiments_neg_over_time.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "sentiments_neg_over_time.pdf")`){target="_blank"}
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_neg_per_countries_all.pdf")`){target="_blank"}

![](`r file.path("ch5_subsidies_reform", "maps", "sentiment_neg_per_countries_10.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_neg_per_countries_10.pdf")`){target="_blank"}
...
This graphs shows the **compound score** of the sentiment analysis over time.  



![](`r file.path("ch5_subsidies_reform", "figures", "sentiments_neu_over_time.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "sentiments_neu_over_time.pdf")`){target="_blank"}
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_neu_per_countries_all.pdf")`){target="_blank"}

![](`r file.path("ch5_subsidies_reform", "maps", "sentiment_neu_per_countries_10.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_neu_per_countries_10.pdf")`){target="_blank"}
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "sentiments_pos_over_time.pdf")`){target="_blank"}

#### Per country

![](`r file.path("ch5_subsidies_reform", "maps", "sentiment_pos_per_countries_all.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_pos_per_countries_all.pdf")`){target="_blank"}
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "figures", "sentiments_comp_over_time.pdf")`){target="_blank"}
...
To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_comp_per_countries_all.pdf")`){target="_blank"}

![](`r file.path("ch5_subsidies_reform", "maps", "sentiment_comp_per_countries_10.png")`)

To download in high resolution, [click here](`r file.path("ch5_subsidies_reform", "maps", "sentiment_comp_per_countries_10.pdf")`){target="_blank"}
