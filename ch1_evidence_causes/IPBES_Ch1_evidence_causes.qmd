...
format:
    html:
        ...
        grid:
            ...
            gutter-width: 1.5rem 
params:
    fn_count: !expr file.path("data", "count.rds")
    fn_corpus_6: !expr file.path("data", "corpus_6.rds") 
    fn_corpus_6_xlsx:  !expr file.path("data", "corpus_6_all.xlsx") 
---
...
ethical_st <- readLines(file.path("input", "ethical.txt")) |>
    paste(collapse = " ")

concepts_1_st <- readLines(file.path("input", "concepts_1.txt")) |>
    paste(collapse = " ")

concepts_2_st <- readLines(file.path("input", "concepts_2.txt")) |>
    paste(collapse = " ")

narrowed_tca_st <- readLines(file.path("input", "narrowed_tca.txt")) |>
    paste(collapse = " ")

criteria_1_st <- readLines(file.path("input", "criteria_1.txt")) |>
    paste(collapse = " ")

criteria_2_st <- readLines(file.path("input", "criteria_2.txt")) |>
    paste(collapse = " ")

criteria_3_st <- readLines(file.path("input", "criteria_3.txt")) |>
    paste(collapse = " ")

criteria_4_st <- readLines(file.path("input", "criteria_4.txt")) |>
    paste(collapse = " ")

biodiv_loss_1_st <- readLines(file.path("input", "biodiv_loss_1.txt")) |>
    paste(collapse = " ")

biodiv_loss_2_st <- readLines(file.path("input", "biodiv_loss_2.txt")) |>
    paste(collapse = " ")

biodiv_loss_3_1_st <- readLines(file.path("input", "biodiv_loss_3_1.txt")) |>
    paste(collapse = " ")

biodiv_loss_3_2_st <- readLines(file.path("input", "biodiv_loss_3_2.txt")) |>
    paste(collapse = " ")

biodiv_loss_3_3_st <- readLines(file.path("input", "biodiv_loss_3_3.txt")) |>
    paste(collapse = " ")

biodiv_loss_3_4_st <- readLines(file.path("input", "biodiv_loss_3_4.txt")) |>
    paste(collapse = " ")

biodiv_loss_3_5_st <- readLines(file.path("input", "biodiv_loss_3_5.txt")) |>
    paste(collapse = " ")
...
data |>
    ...
    writexl::write_xlsx(path = file.path("data", "samples_4.2_narrowed_tca.xlsx"))
rm(data)
...
data |>
    ...
    writexl::write_xlsx(path = file.path("data", "samples_5.1_narrowed_criteria1.xlsx"))
rm(data)
...
data |>
    ...
    writexl::write_xlsx(path = file.path("data", "samples_5.2_narrowed_criteria2.xlsx"))
rm(data)
...
data |>
    ...
    writexl::write_xlsx(path = file.path("data", "samples_5.3_narrowed_criteria3.xlsx"))
rm(data)
...
data |>
    ...
    writexl::write_xlsx(path = file.path("data", "samples_5.4_narrowed_criteria4.xlsx"))
rm(data)
...
basename <- file.path("figures", "Ch1_evidence_causes")
...
if (nf < 3) {
    puml <- readLines(file.path("input", "Ch1_evidence_causes.plantuml"))
    ...
    puml |>
        ...
        plantuml::plantuml() |>
        plantuml::get_graph(
            file = file.path("figures", "Ch1_evidence_causes.pdf")
        )
    ...
    puml |>
        ...
        plantuml::plantuml() |>
        plantuml::get_graph(
            file = file.path("figures", "Ch1_evidence_causes.svg")
        )
    ...
    puml |>
        ...
        plantuml::plantuml() |>
        plantuml::get_graph(
            file = file.path("figures", "Ch1_evidence_causes.png")
        )
}
```
...
![Overview of the analysis and results.](figures/Ch1_evidence_causes.svg){width=100% height=100%}

- To download png, [click here](figures/Ch1_evidence_causes.png){target="_blank"}.
- To download high resolution pdf, [click here](figures/Ch1_evidence_causes.pdf){target="_blank"}.
- To download high resolution svg, [click here](figures/Ch1_evidence_causes.svg){target="_blank"}.
