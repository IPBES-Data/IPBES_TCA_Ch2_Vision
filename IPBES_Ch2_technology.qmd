...
params:
    ...
    #
    corpus_tca_dir: !expr file.path("ch2_technology", "data", "tca_corpus", "corpus")
    corpus_cases_dir: !expr file.path("..", "IPBES_TCA_Corpus", "ch2_technology", "data", "tca_corpus", "corpus_cases")
    #
...
if (!exists("params")) {
    params <- rmarkdown::yaml_front_matter("IPBES_Ch2_technology.qmd")$params
}
...
The corpus download will be stored in `ch2_technology/pages` and the arrow database in `ch2_technology/data/corpus_complete`. This one will be filtered with the TCA / G;obal Corpus and get the final name `ch2_technology/data/corpus`.
...
(read_corpus("./ch2_technology/data/corpus_deduplicated") |> group_by(id) |> summarize(n = n()) |> filter(n > 1) |> collect() |> nrow()) / (corpus_read("./ch2_technology/data/corpus_deduplicated") |> nrow())
...
if (length(list.files(path = file.path("ch2_technology", "maps"), pattern = "sentiment_neu_per_countries")) < 4) {
...
if (length(list.files(path = file.path("ch2_technology", "maps"), pattern = "sentiment_pos_per_countries")) < 4) {
    data <- readRDS(params$fn_sentiment_spatial_data)
...
#|
if (length(list.files(path = file.path("ch2_technology", "maps"), pattern = "sentiment_neg_per_countries")) < 4) {
    data <- readRDS(params$fn_sentiment_spatial_data)
...
if (length(list.files(path = file.path("ch2_technology", "maps"), pattern = "sentiment_comp_per_countries")) < 4) {
    data <- readRDS(params$fn_sentiment_spatial_data)
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_over_time")) < 2) {
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_over_time_neg_pos")) < 2) {
    figure <- readRDS(params$fn_sentiment_temporal_data) |>
        dplyr::filter(
            n > params$min_count_sentiment_timeseries
        ) |>
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_marine_over_time_neg_pos")) < 2) {
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_neg_over_time")) < 2) {
    figure <- readRDS(params$fn_sentiment_temporal_data) |>
        dplyr::filter(
            n > params$min_count_sentiment_timeseries
        ) |>
...
#|
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_neu_over_time")) < 2) {
    figure <- readRDS(params$fn_sentiment_temporal_data) |>
        dplyr::filter(
            n > params$min_count_sentiment_timeseries
        ) |>
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_pos_over_time")) < 2) {
    figure <- readRDS(params$fn_sentiment_temporal_data) |>
        dplyr::filter(
            n > params$min_count_sentiment_timeseries
        ) |>
...
#|
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_comp_over_time")) < 2) {
    figure <- readRDS(params$fn_sentiment_temporal_data) |>
        dplyr::filter(
            n > params$min_count_sentiment_timeseries
        ) |>
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_marine_over_time_neg_pos_ridge")) < 2) {
...
if (length(list.files(path = file.path("ch2_technology", "figures"), pattern = "sentiments_over_time_neg_pos_ridge")) < 2) {
    figure <- readRDS(params$fn_sentiment_results) |>
        select(
            work_id = id,
            year = date,
